...
ggsave("./models/glmnet/2017-07-21 glmnet all datapoints.png")
...
ggsave("./models/glmnet/2017-07-21 glmnet alpha-cd.png")
...
ggsave("./models/glmnet/2017-07-21 glmnet beta-cd.png")
...
ggsave("./models/glmnet/2017-07-21 glmnet gamma-cd.png")
...
ggsave("./models/glmnet/2017-07-21 glmnet compiled.png")
...
ggplot(glm.abc.tst, aes(x = obs, y = residual, color = cd.type)) + 
  ...
  labs(y = "Residuals, kJ/mol", x = "Expeirmental DelG, kJ/mol", 
       ...
       color = "Cyclodextrin")
ggsave("./models/glmnet/2017-07-21 glmnet compiled resid.png")
